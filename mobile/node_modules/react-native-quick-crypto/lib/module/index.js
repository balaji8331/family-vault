...
export const install = () => {
  ...
  global.base64ToArrayBuffer = (s, removeLinebreaks) => toByteArray(s, removeLinebreaks).buffer;
  global.base64FromArrayBuffer = (b, urlSafe) => fromByteArray(new Uint8Array(b), urlSafe);
};

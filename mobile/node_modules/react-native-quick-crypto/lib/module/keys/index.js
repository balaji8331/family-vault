...
function prepareAsymmetricKey(key, isPublic) {
  ...
  if (typeof key === 'object' && 'key' in key) {
    ...
    const passphraseAB = passphrase !== undefined ? toAB(passphrase) : undefined;
...
function createPublicKey(key) {
  ...
  if (typeof key === 'object' && 'key' in key && key.format === 'jwk') {
    ...
    if (keyType === KeyType.PRIVATE) {
      ...
      const pubHandle = NitroModules.createHybridObject('KeyObjectHandle');
      pubHandle.init(KeyType.PUBLIC, exported, KFormatType.DER, KeyEncoding.SPKI);
  ...
  return KeyObject.createKeyObject('public', data, kFormat, kType, passphrase);
}
function createPrivateKey(key) {
  ...
  return KeyObject.createKeyObject('private', data, kFormat, kType, passphrase);
}
...
export {
// Node Public API
createSecretKey, createPublicKey, createPrivateKey, CryptoKey, generateKey, generateKeySync, generateKeyPair, generateKeyPairSync, AsymmetricKeyObject, KeyObject, createSign, createVerify, sign, verify, Sign, Verify, publicEncrypt, publicDecrypt, privateEncrypt, privateDecrypt,
// Node Internal API

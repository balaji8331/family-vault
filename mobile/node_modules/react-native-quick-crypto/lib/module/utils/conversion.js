...
const canGetU16StringFromJsiString = !(Platform.constants.reactNativeVersion.major == 0 && Platform.constants.reactNativeVersion.minor < 78);

// v0.79.0, https://github.com/facebook/react-native/commit/d9d824055e9f24614abd5657f9fc89a6ab3f2da2
const canCreateJsiStringFromUtf16 = !(Platform.constants.reactNativeVersion.major == 0 && Platform.constants.reactNativeVersion.minor < 79);
...
export function rejectSharedArrayBuffer(buf) {
...
export function ab2str(buf, encoding = 'hex', start, end) {
...
export function bufferToString(buf, encoding = 'hex', start, end) {

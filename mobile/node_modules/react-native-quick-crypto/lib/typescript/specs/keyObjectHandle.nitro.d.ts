...
export interface KeyObjectHandle extends HybridObject<{
    ...
    initRawPublic(asymmetricKeyType: string, keyData: ArrayBuffer, namedCurve?: string): boolean;
    initRawPrivate(asymmetricKeyType: string, keyData: ArrayBuffer, namedCurve?: string): boolean;

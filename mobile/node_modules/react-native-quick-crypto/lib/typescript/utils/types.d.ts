...
export type EncryptDecryptParams = AesCbcParams | AesCtrParams | AesGcmParams | AesOcbParams | AesKwParams | RsaOaepParams | ChaCha20Poly1305Params;
...
export type Operation = 'encrypt' | 'decrypt' | 'sign' | 'verify' | 'generateKey' | 'importKey' | 'exportKey' | 'deriveBits' | 'wrapKey' | 'unwrapKey' | 'encapsulateBits' | 'decapsulateBits' | 'encapsulateKey' | 'decapsulateKey' | 'digest' | 'get key length';
